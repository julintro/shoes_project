...
[y_new_w, Ne_w , N_eff] = splitSignalIntoBlocks(y_new, n_window);   % y_new_w : matrix containing the windows as vector
                                                                    % N_eff = number of points effectively used
[y_old_w , ~ , ~] = splitSignalIntoBlocks(y_old, n_window);